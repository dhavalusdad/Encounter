...
const Chronic = () => {
  ...
  >({
    mode: 'onChange',
    defaultValues: form['chronic']
  });

  const currentForm = tabArray.find((el) => el.id === 'chronic');
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-4">
        ...
        <Button
          onClick={() => {
            ...
            dispatchUpdateEncounterValue({ chronic: defaultValue });
        ...
        <Button
          onClick={handleSubmit((value) => {
            dispatchUpdateEncounterValue({ chronic: value })
